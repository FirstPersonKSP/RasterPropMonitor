    ...
    internal class JSIMechJeb : IJSIModule
    {
        ...
        static JSIMechJeb()
        {
            ...
            try
            {
                ...
                if (mjStageDv == null)
                {
                    // Try lowercase for older versions
                    mjStageDv = mjFuelStats_t.GetField("deltaV", BindingFlags.Instance | BindingFlags.Public);
                }
                if (mjStageDv == null)
                {
        ...
        public double SpaceplaneHoldAltitude()
        {
            ...
            if (ap != null && spaceplaneAltitude != null)
            {
        ...
        public double SpaceplaneHoldHeading()
        {
            object activeJeb = GetMasterMechJeb(vessel);
            object ap = GetComputerModule(activeJeb, "MechJebModuleSpaceplaneAutopilot");
            if (ap != null && spaceplaneHeading != null)
            {
        ...
        public double SpaceplaneGlideslope()
        {
            object activeJeb = GetMasterMechJeb(vessel);
            object ap = GetComputerModule(activeJeb, "MechJebModuleSpaceplaneAutopilot");
            if (ap != null && spaceplaneGlideslope != null)
            {
        ...
        public void ButtonSpaceplaneHoldHeading(bool state)
        {
            ...
            if (ap != null && controller != null && spaceplaneHoldHeading != null)
            {
                if (state)
                {
        ...
        public bool ButtonSpaceplaneHoldHeadingState()
        {
            object activeJeb = GetMasterMechJeb(vessel);
            object ap = GetComputerModule(activeJeb, "MechJebModuleSpaceplaneAutopilot");
            if (ap != null && spaceplaneAPMode != null)
            {
